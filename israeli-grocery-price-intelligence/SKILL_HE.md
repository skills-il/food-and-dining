...
| ויקטורי | בהתאם לרשת | חברה ציבורית עצמאית, נפרדת מקרפור ישראל |
| אושר עד | בהתאם לרשת | רשת דיסקאונט |
| קרפור ישראל (לשעבר מגה/יינות ביתן) | בהתאם לרשת | מיתוג מחדש ממגה/יינות ביתן ב-2022-2023 |
...
- כתובות ה-URL וסכמות ה-XML של רשתות הסופרמרקט בישראל משתנות ללא הודעה מוקדמת. סוכנים שמסתמכים על כתובות מהזיכרון או מנתוני האימון ייתקלו בקישורים שבורים. תמיד יש לוודא את כתובות הפידים מ-`references/chain-feeds.md` לפני שליחת שאילתות.
- מחירים בישראל כוללים מע"מ (18%) כברירת מחדל, בניגוד למחירים בארה"ב שהם לפני מס. סוכנים עלולים לבצע השוואות מחירים שסופרים מע"מ פעמיים או מתעלמים ממנו.
...
- "מגה" ו"יינות ביתן" עברו מיתוג מחדש לקרפור ישראל ב-2022-2023. "ויקטורי" היא חברה ציבורית נפרדת. סוכנים עלולים עדיין להתייחס לקיבוץ המיושן "ויקטורי / מגה" או להניח שיש להם מדיניות תמחור משותפת.
